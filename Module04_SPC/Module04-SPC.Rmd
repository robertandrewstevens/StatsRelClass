...
- A process "in control" is simply one that runs smoothly enough to be predictable
    ...
    + We do not have to like the process performance that we are able to predict
